...
- 计算机的研制：ENIAC 主要用于解决长程火炮过程中的计算问题，需要通过修改线路，完成其他方向的计算；EDVAC 提供了新的设计方案，是世界上第一台程序控制的通用电子计算机
...
- 大数的认知
    - 财务软件的故事：最初对一次账几秒，当数据量大 10 倍之后，对账时间超过了十倍
...
- 汽车：硬件是发动机、底盘、车身和电气设备；软件是智能 AI 系统，比如倒车影像位置识别，车身感应器等
