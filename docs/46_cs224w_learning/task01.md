...
- 任意尺寸输入、拓扑复杂
- 没有固定节点顺序和参考锚点
- 动态变化，具有多模态特征（例如歌曲，包括音频、视频 MV、歌手介绍等特征）
...
- PyG（PyTorch Geometric）：官方自己的库，和 PyTorch 类似
- GraphGym
- NetworkX
...
- 分析节点重要度（Centrality / Importance）：PageRank 算法、网页排名
